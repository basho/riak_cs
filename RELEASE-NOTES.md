...
* Fix `URL path` resource and query parameters to work in AWS v4. Previously, '+' was being input instead of '%' for blank spaces. ([PR#1141](https://github.com/basho/riak_cs/pull/1141))

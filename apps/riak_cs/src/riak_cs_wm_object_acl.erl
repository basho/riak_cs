...
-spec content_types_accepted(term(), term()) -> {[{string(), atom()}], #wm_reqdata{}, #rcs_web_context{}}.
content_types_accepted(RD, Ctx = #rcs_web_context{local_context = LocalCtx0}) ->
        ...
        CType ->
            ...
            case string:tokens(Media, "/") of
                [_Type, _Subtype] ->
                    ...
                    {[{Media, add_acl_to_context_then_accept}],
                     RD, Ctx#rcs_web_context{local_context = LocalCtx}};
                _ ->
                    %% TODO:

...
process_post_helper(RD, Ctx = #rcs_web_context{riak_client = RcPid,
...
valid_entity_length(RD, Ctx = #rcs_web_context{local_context = LocalCtx}) ->
...
content_types_provided(RD, Ctx = #rcs_web_context{}) ->
    Method = wrq:method(RD),
    if Method == 'POST' ->

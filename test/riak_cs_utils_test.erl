...
bucket_resolution_test() ->
    ...
    UserRecord = riak_cs_utils:user_record("uncle fester",
                                           ...
                                           "festersquest",
                                           "wasthebest"),
    BucketList1 = [riak_cs_utils:bucket_record(<<"bucket1">>, create, undefined),
                   riak_cs_utils:bucket_record(<<"bucket2">>, create, undefined),
                   riak_cs_utils:bucket_record(<<"bucket3">>, create, undefined)],
    BucketList2 = [riak_cs_utils:bucket_record(<<"bucket1">>, create, undefined),
                   riak_cs_utils:bucket_record(<<"bucket1">>, create, undefined),
                   riak_cs_utils:bucket_record(<<"bucket1">>, create, undefined)],
    BucketList3 = [riak_cs_utils:bucket_record(<<"bucket1">>, create, undefined),
                   riak_cs_utils:bucket_record(<<"bucket1">>, delete, undefined),
                   riak_cs_utils:bucket_record(<<"bucket1">>, create, undefined)],
    BucketList4 = [riak_cs_utils:bucket_record(<<"bucket1">>, create, undefined),
                   riak_cs_utils:bucket_record(<<"bucket1">>, create, undefined),
                   riak_cs_utils:bucket_record(<<"bucket1">>, delete, undefined)],
    BucketList5 = [riak_cs_utils:bucket_record(<<"bucket1">>, delete, undefined),
                   riak_cs_utils:bucket_record(<<"bucket1">>, delete, undefined),
                   riak_cs_utils:bucket_record(<<"bucket1">>, delete, undefined)],

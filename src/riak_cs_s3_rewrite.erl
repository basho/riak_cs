...
rewrite_path_test() ->
    ...
    equal_paths("/buckets/testbucket/policy",
                rewrite_with(headers([{"host", "testbucket." ++ ?ROOT_HOST}]),
                             "/?policy")),
    equal_paths("/buckets/testbucket/lifecycle",
                rewrite_with(headers([]),
                             "/testbucket?lifecycle")),
    equal_paths("/buckets/testbucket/lifecycle",
                rewrite_with(headers([{"host", "testbucket." ++ ?ROOT_HOST}]),
                             "/?lifecycle")),
    ...
    equal_paths("/buckets/testbucket/objects/testdir%2Ftestobject/restore",
                rewrite_with(headers([]),
                             "/testbucket/testdir/testobject?restore")),
    equal_paths("/buckets/testbucket/objects/testobject/restore",
                rewrite_with(headers([{"host", "testbucket." ++ ?ROOT_HOST}]),
                             "/testobject?restore")),

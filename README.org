...
** Compatible clients and libraries
  ...
  - [[https://github.com/s3tools/s3cmd][s3cmd]]
  - [[http://aws.amazon.com/code/128][s3curl]]
  - [[https://github.com/boto/boto][boto]]
  - [[https://github.com/basho/erlcloud][erlcloud]]
  - [[http://aws.amazon.com/sdkforjava/][AWS Java SDK]]
  - [[http://aws.amazon.com/sdkforruby/][AWS Ruby SDK]]
  - [[http://fog.io/][Fog]]
...
** Administrative interface
  ...
  under the =/riak-cs/= resource. The administrative interface features the following capabilities:
...
** Repo organization
  Riak CS uses the [[http://nvie.com/posts/a-successful-git-branching-model/][git-flow]] branching model and we have the default
  ...
  tag. /e.g./ For the /1.3.0/ release use the following command: =git
  checkout 1.3.0=.

* Where to find more

Below, you'll find a direct link to a guide to quickly getting started
with Riak CS. For more information about Riak CS please visit our [[http://docs.basho.com/riakcs/latest][docs]].
...
** Testing
  ...
  Also see the /Testing/ section of the Riak CS repo [[https://github.com/basho/riak_cs/wiki][wiki]] for more
